...
def refine(
    ...
    ╔══════════════════════════════════════════════════════════════╗
    ║  ⭐ `extend_to_stop` — **تناقضٌ داخليّ، لا رقمٌ جديد**         ║
    ║                                                              ║
    ║  الوقفُ الذي قَبِله البوت أصلًا هو `zone_stop` — أي            ║
    ║  `قاع المنطقة − الهامش`. فهو **يخاطر إلى هناك على كلّ حال**.  ║
    ║  ومع ذلك يختبر الاحتواءَ عند `zone_bottom` وحده، فيردّ        ║
    ║  نموذجًا قاعُه **بين الحدّين** — داخل مخاطرةٍ قَبِلها بالفعل.   ║
    ║                                                              ║
    ║  وعلّةُ شرط الاحتواء المكتوبة: «نموذجٌ طرفُه **بعيدٌ عن         ║
    ║  المنطقة** إعدادٌ مستقلّ في مكانٍ آخر من الشارت». ونموذجٌ      ║
    ║  قاعُه فوق وقفِ هذه الصفقة **ليس في مكانٍ آخر**.               ║
    ║                                                              ║
    ║  ⇒ فهذا **ليس سماحيّةً تُضبط** (`tolerance` رقمٌ يُختار)،      ║
    ║  بل حدُّ المخاطرة القائم نفسُه. وسطرٌ واحد يكفيه في            ║
    ║  الاتّجاهين: `lo`/`hi` تبتلع `zone_stop` أيًّا كانت جهتُه.     ║
    ║                                                              ║
    ║  ⛔ **ولا يوسّع وقفًا أبدًا**: الحارس `risk >= zone_risk`      ║
    ║  أدناه يردّ كلَّ تنقيحٍ لا يشدّ. فأثرُه إمّا وقفٌ **أضيق**      ║
    ║  وإمّا **لا شيء**.                                           ║
    ║                                                              ║
    ║  ⚠️ **ومع ذلك يبقى مطفأً افتراضيًّا.** فالوقفُ الأضيق يُضرب   ║
    ║  أكثر، وذلك **يُقاس ولا يُفترض** — وقياسٌ سابقٌ (ملوَّثٌ        ║
    ║  بفجوة شموع التأكيد) لمّح إلى أنّ المنقَّح هو الخاسر.          ║
    ╚══════════════════════════════════════════════════════════════╝
    """
