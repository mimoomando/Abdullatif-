...
مرجع الإرساء يختلف حسب **نوع الكائن** — وهذا محسوم (C1، 2026-08-26):
    ...
    الدرس 12 : القنوات «تسمح بالذيول وتفضّل الأجسام» ⇒ اعتُمدت الأجسام
    الدرس 8  : حدود Flag / Pennant على **الذيول** صراحةً

`anchor` يبقى معاملًا صريحًا لا قيمة مخفية. الجدول المرجعي الكامل في
`params.ANCHOR_BY_OBJECT`.
"""
