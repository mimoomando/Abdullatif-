...
class ChainConfig:
    ...
    #
    # ⛔ ومُطفَأ حتى يُقاس وحده: الفرعُ منصوصٌ للمنعكسة («أنا منها بفوت
    #    شراء **مع تأكيد من الفريم المرتبط**»)، فإغلاقُه يردّ نصًّا —
    #    ولا يُردّ نصٌّ إلّا بقياسٍ صريح.
    direct_touch_only: bool = False
