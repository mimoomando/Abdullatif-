...
class ChainConfig:
    ...
    #
    # ⚠️ **وشرطٌ يُذكر مع الرقم:** ذلك التشغيل لم يُعطَ الإطار الأعلى،
    #    فبوّابتا H1 لم تعملا فيه (خطُّ أساسه −75.01$ لا −42.01$).
    #    فالأثران قد يتداخلان، **والرقم المشترك يحتاج تشغيلًا مؤكِّدًا**.
    #
