...
# ══════════════════════════════════════════════════════════════════
# T2 — ما معنى «أدنى القاع بقليل»؟  ✅ محسوم 2026-08-27
#
# «أدنى قاع الأوردر بلوك بقليل **مشان السبريد**»
# ⇒ الهامش ليس رقمًا اعتباطيًا بل السبريد نفسه.
# ══════════════════════════════════════════════════════════════════
...
STOP_BUFFER_MODE = Param(
    ...
    origin="SOURCE",
    lesson="م2/د3 ≈15:55",
    note="الوقف = أدنى قاع الأوردر بلوك − السبريد الحي. "
         "يُقرأ من مواصفات XAUUSD.m لحظة الحساب، لا يُثبَّت رقمًا.",
)
...
SPREAD_BUFFER_POINTS = Param(
    ...
    origin="SOURCE",
    lesson="م2/د3",
    note="لا قيمة ثابتة — انظر STOP_BUFFER_MODE: يُقرأ حيًّا من الطرفية.",
)
