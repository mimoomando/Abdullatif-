...
#
# ⚠️ **الوحدة ما زالت مفتوحة**: كم سعرًا تساوي «الدرجة»؟
#     انظر DEGREE_VALUE أدناه — وبدونها لا يُحسب وقف.
# ══════════════════════════════════════════════════════════════════
...
DEGREE_VALUE = Param(
    value=None,
    origin="UNDEFINED",
    lesson="§17 — سؤال معلّق على المستخدم 2026-08-27",
    note="كم سعرًا تساوي «الدرجة» على XAUUSD.m؟ الفارق ليس تفصيلًا: "
         "0.01 ⇒ هامش 0.02 (داخل السبريد، يُضرب فورًا) · "
         "0.10 ⇒ 0.20 (بحجم سبريد الذهب تقريبًا) · "
         "1.00 ⇒ 2.00 دولار (هامش معقول لأوردر بلوك على H1/H4). "
         "⛔ لا يُخمَّن: الخطأ هنا بمضاعف 100 على كل وقف.",
)
